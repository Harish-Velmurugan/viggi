...
urlpatterns = [
   path('dashboard-piv-view/<str:un>/',views.dashboardPIView, name="dashboard-piv-view"),
   path('dashboard-ppp-view/<str:pk>/', views.dashboardPPView, name="dashboard-ppp-view"),
   path('ppo-view/<str:pk>/<str:un>/', views.postedProblemView, name="dashboard-ppo-view"),
   ...
   path('problemDescription/<str:pk>/',views.problemDescription,name="problemDescription"),
   path('problemDeadline/<str:pk>/',views.problemDeadline,name="problemDeadline"),
   path('topChallangesHomePage/',views.topChallangesHomePage,name="topchallanges"),
   ...
   path('extendTimeAccepted/<str:pid>/<str:days>/<str:nid>/', views.extendTimeAccepted),
   path('extendTimeRejected/<str:pid>/<str:uid>/<str:nid>/', views.extendTimeRejected),
