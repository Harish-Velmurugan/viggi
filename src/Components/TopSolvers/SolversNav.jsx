...
class SolversNav extends Component {
  constructor(props) {
    super(props);
    this.state = {
      personal: [],
  ...
  componentDidMount() {
    ...
    if (this.props.location.state == undefined) {
      var url = `/dashboard/toprankerNav/${Number(username)}/`;
      axios
        .get(url)
        .then((response) => {
      ...
      // url="/dashboard/domainSearch/"+this.props.location.state.query+"/"+this.props.location.state.query1+"/";
