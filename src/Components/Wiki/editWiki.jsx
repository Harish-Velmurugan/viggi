  ...
  constructor(props)
    ...
    componentDidMount(){
        ...
        .then((res=>{
            ...
            this.setState({'value': RichTextEditor.createValueFromString(res.data.body, 'markdown') })
          })
      ...
      return (
        <div>
          ...
          Publish
                ...
                <span><Link>
                <a/><img class="float-right mr-5 mb-4 box1"  style={{ display: "inline-block", transition: "1s" }}
              src={help} height="50px" width="50px"/></Link>
              
              
                  <h4 className="ml-5" style={{color:'grey'}}>Start Creating Your Wiki....
                  

                  </h4></span>
                  
                  <div class="shadow-lg bg-white rounded" style={{width:'75%',heigth:"5%",marginLeft:'10%',marginTop:"0%",padding:"auto",backgroundColor:"#c0c0c0"}}>
                    
                  <div style={{width:"73%",marginLeft:"14%",paddingTop:"4%",paddingBottom:'4%'}}>

                  <div class="form-group">
              <label for="exampleInputEmail1"></label>
              <input type="text" class="form-control" id="title" name="title"    maxlength="70" placeholder="Title of your wiki" value={this.state.title} onChange={this.handleChange}/>
               </div>
                Choose Domain
                <select class="form-control mb-4" placeholder="Choose domain" id='domain' name='domain' onChange={this.handleChange}>
                {<option selected>{this.state.domain}</option>}
                <option value="Algorithms">Algorithms</option>
    <option value="Cryptography">Cryptography</option>
    <option value="Distributed Computing">Distributed Computing</option>
    <option value="Cloud Computing">Cloud Computing</option>
    <option value="Computational Learning">Computational Learning</option>
