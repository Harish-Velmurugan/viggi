...
class CUpdateProfile extends Component {
  ...
  render() {
    console.log(this.state.professional, this.state.personal,localStorage.getItem("signin"));
    if (
    ...
    return (
      <div className="container-fluid update" style={{ fontFamily: "Arial" }}>
        ...
        <div className="container" style={{ width: "100%", marginTop: "5rem" }}>
          <div className="row" style={{ marginLeft: "90pt" }}>
            <div className="col">
              <div className="container1" >
                <label>
                  ...
                  />
                  {/* <img id="profileImage" className="img" src={localStorage.getItem('ima')} alt='image' style={{ marginTop: "0rem", height: "200px", width: "200px" }} /> */}
                </label>
              </div>
            </div>
            <div className="col-sm-6" style={{ marginRight: "70pt" }}>
              <br />
              ...
              >
                We are a renowed company looking forward to collaborate and work with self motivated intellects.
              </div>
            </div>
            <div className="col">
              {/* <div className="card" style={{ marginTop:"1rem",fontStyle: "bold", padding: "15pt", width: "100%" }}>Profile Completeness<hr></hr>{this.state.profilecomplete}%
                <div className="progress" style={{ width: "100%", alignItems: "justify" }}>
                <div className="progress-bar" 
                style={{width:`${this.state.profilecomplete}%`, backgroundColor: "#323754", color: "white", textAlign: "justify" }}
                >
                 </div>
                </div>
              </div> */}
